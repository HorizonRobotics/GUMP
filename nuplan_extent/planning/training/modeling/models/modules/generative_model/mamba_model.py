...
try:
    ...
    print("Could not import selective_scan_cuda")
...
class MambaModel(nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        _bsz, token_seqlen, _ = inputs_embeds.shape
        _bsz, visual_seqlen, _ = visual_embeds.shape

        # h = self.tok_embeddings(tokens)
        hidden_states = torch.cat([visual_embeds, inputs_embeds], dim=1)
        ...
        hidden_states = hidden_states[:, visual_seqlen:,:]
