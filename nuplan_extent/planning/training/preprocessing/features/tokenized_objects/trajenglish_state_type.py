...
class TrajenglishVocabularyStateType(Enum):
    """Enum of classification types for TrackedObject with integer ranges."""

    EGO = (0, 0), 'ego', 0
    AGENTS = (1, 521), 'agents', 1
    CLASS_TYPE = (522, 524), 'class_type', 2
    KDISK_TOKEN = (525, 1548), 'kdisk_token', 3
    BOS_TOKEN = (1549, 1549), 'bos_token', 4
    NEWBORN_BEGIN_TOKEN = (1550, 1550), 'newborn_bos_token', 5
    PAD_TOKEN = (1551, 1551), 'pad_token', 6
