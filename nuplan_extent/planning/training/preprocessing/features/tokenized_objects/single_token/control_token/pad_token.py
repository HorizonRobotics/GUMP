...
class PADToken(BaseSingleToken):
    """
    ...
    def __init__(self, frame_index=0):
        ...
        """
        super().__init__(value=VocabularyStateType.PAD_TOKEN.start, token_type='control', frame_index=frame_index)
    ...
    def __eq__(self, token) -> bool:
        if not isinstance(token, PADToken):
            return False
    ...
    def get_control_state(self):
        ...
        """
        return VocabularyStateType.PAD_TOKEN.start
