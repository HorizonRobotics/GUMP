...
class VocabularyStateType(Enum):
    ...
    X = (525, 1524), 'x', 3 # 1000, 0.2, -100, 100
    Y = (1525, 2524), 'y', 4 # 1000, 0.2, -100, 100
    HEADING = (2525, 2724), 'heading', 5, # 200, np.pi/100, -np.pi, np.pi
    VX = (2725, 2924), 'vx', 6 # 200, 0.25, -25, 25
    VY = (2925, 3124), 'vy', 7 # 200, 0.25, -25, 25
    WIDTH = (3125, 3139), 'width', 8 # 15
    LENGTH = (3140, 3169), 'length', 9 #30
    BOS_TOKEN = (3170, 3170), 'bos_token', 10
    NEWBORN_BEGIN_TOKEN = (3171, 3171), 'newborn_begin_token', 11
    TRAFFIC_LIGHT_END_TOKEN = (3172, 3172), 'traffic_light_end_token', 12
    PAD_TOKEN = (3173, 3173), 'pad_token', 13
